...
/**
   ...
   5% will be given to RPX Foundation
...
contract RockPaperX is Context, IERC20, Ownable {
    ...
    address payable public rpxFoundation = 0x0745aBb4895f528d426d8F14646c85fc58452880; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tRpxTotal = _tRpxTotal.add(address(this).balance);
        TransferCharityETH(rpxFoundation, address(this).balance);
    }
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _rpxFee == 0) return;
